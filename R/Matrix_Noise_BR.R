...
#' @noRd
mv_noise_convex_hull_support <- function(x_list, jitter = 1e-08) {
...
#' @param support Convex-hull support from `mv_noise_convex_hull_support()`.
#'
#' @return Numeric vector of log-densities.
#' @noRd
mv_noise_br_log_density <- function(x_list, support) {
